...
def last_eval(
    ...
    #rec_idxs = rec_idxs.cpu().detach().numpy()
    rec_result = np.array(rec_idxs.cpu().detach())
    #rec_result.dtype = 'int8'
    print(rec_result)
    #pdb.set_trace()
    ...
    #pdb.set_trace()
    #rec_idxs.to_csv("/home/math-tr/xq/dbrl_1/bigdata2021-rl-recsys/track_2.csv", header=None, index=False)
    
    np.savetxt("/home/math-tr/xq/dbrl_1/bigdata2021-rl-recsys/track_2_reward1122.csv",rec_result)
    #np.savetxt("/home/math-tr/xq/dbrl_1/bigdata2021-rl-recsys/track_2_ddpg.csv",rec_result)
    #with open("track_2.txt","w") as f:
    #    f.write()
