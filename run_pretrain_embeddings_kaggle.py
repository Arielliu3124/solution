...
from dbrl_1.data import process_feat_data, FeatDataset
from dbrl_1.models import DSSM
from dbrl_1.utils import sample_items_random, init_param_dssm, generate_embeddings
from dbrl_1.trainer import pretrain_model
from dbrl_1.serialization import save_npy, save_json
import pdb
...
if __name__ == "__main__":
    ...
    criterion = (
        ...
        if args.loss == "cosine"
        else nn.BCEWithLogitsLoss()                #有两个损失函数可以选择
    )
    criterion_type = (
        "cosine"
