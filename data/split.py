...
def split_by_ratio(data, shuffle=False, test_size=None, pad_unknown=True,
    ...
    #pdb.set_trace()
    user_split_indices = groupby_user(user_indices)    #转到2
    #pdb.set_trace()
    split_indices_all = [[], []]
    ...
    #pdb.set_trace()
    if pad_unknown:
        split_data_all = _pad_unknown_item(split_data_all)         #转到3
    elif filter_unknown:
        split_data_all = _filter_unknown_user_item(split_data_all)    #转到4
    #pdb.set_trace()
